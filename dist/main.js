...
var StudentService = /** @class */ (function () {
    ...
    StudentService.prototype.addStudent = function (studentData) {
        var uri = 'https://vast-springs-98239.herokuapp.com/students/add';
        var obj = {
    ...
    StudentService.prototype.getStudents = function () {
        var uri = 'https://vast-springs-98239.herokuapp.com/students';
        return this
            .http
            .get(uri)
            .map(function (res) {
    ...
    StudentService.prototype.editStudent = function (id) {
        var uri = 'https://vast-springs-98239.herokuapp.com/students/edit/' + id;
        return this
            .http
            .get(uri)
            .map(function (res) {
    ...
    StudentService.prototype.updateStudent = function (studentData) {
        var uri = 'https://vast-springs-98239.herokuapp.com/students/update/' + studentData._id;
        var obj = {
            fname: studentData.fname,
            lname: studentData.lname
        };
    ...
    StudentService.prototype.deleteStudent = function (id) {
        var uri = 'https://vast-springs-98239.herokuapp.com/students/delete/' + id;
        return this
            .http
            .get(uri)
            .map(function (res) {
...
module.exports = __webpack_require__(/*! /Users/skapale/Development/dev/test1/src/main.ts */"./src/main.ts");
